...
const Card = ({ image, name }) => {
  ...
  return (
    <motion.div
      className="relative  overflow-hidden h-[100px] min-w-[100px]  2xl:h-[120px]  2xl:min-w-[120px] rounded-sm  flex justify-center items-center group   hover:cursor-pointer transition-all duration-500"
      key={image}
